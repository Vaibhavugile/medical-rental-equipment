...
export default function EquipmentList() {
	...
	useEffect(() => {
  document.title = "Medical Equipment on Rent";
      ...
      <section className="me-hero-alt">
        <div className="me-hero-alt-inner">
          ...
          <div className="me-hero-alt-img">
            <img
              src="/medical.jpg"
              alt="Medical Equipment on Rental"
            />
          </div>
      ...
      <section className="me-grid">
        {equipmentList.map((eq) => (
          <article
            ...
            role="button"
            tabIndex={0}
            onClick={() => navigate(`/medical-equipment-on-rent/${eq.slug}`)}
            onKeyDown={(e) => {
              if (e.key === "Enter") {
                navigate(`/medical-equipment-on-rent/${eq.slug}`);
              }
            }}
          >
            {/* IMAGE */}
